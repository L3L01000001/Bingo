...
{
    public class ProductsWithSubCategoriesAndBrandsSpecification : BaseSpecification<Product>
    {
        public ProductsWithSubCategoriesAndBrandsSpecification(ProductSpecParams productParams):
            base(
                x => 
        ...
        public ProductsWithSubCategoriesAndBrandsSpecification(int id) 
        : base(x => x.Id == id)
        {  
            AddInclude(x => x.SubCategory);
            AddInclude(x => x.Brand);
